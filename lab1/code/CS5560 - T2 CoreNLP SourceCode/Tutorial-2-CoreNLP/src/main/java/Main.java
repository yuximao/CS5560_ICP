...
// read some text in the text variable
        String text = "The relation of cigarette smoking to natural menopause has been evaluated in two independent sets of data. It causes death."; // Add your text here!
